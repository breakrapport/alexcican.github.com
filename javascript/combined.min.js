...
if(confirm("A new version of this site is available. Load it?")){window.location.reload();}}else{}},false);},false);(function(b){"use strict",b.fn.jribbble=function(){return this.makeRequest=function(a,j,i){var h=function(c){b.isFunction(j)&&j(c);
},g=a.replace("//","/");b.ajax({data:i,dataType:"jsonp",success:h,type:"GET",url:b.jribbble.baseUrl+g});},this;},b.jribbble={},b.jribbble.baseUrl="http://api.dribbble.com",b.jribbble.paths={shots:"/shots/",rebounds:"/rebounds/",following:"/following/",players:"/players/",followers:"/followers/",draftees:"/draftees/",comments:"/comments/",likes:"/likes/"},b.jribbble.getShotById=function(a,f){var e=b.jribbble.paths.shots+a;
b.fn.jribbble().makeRequest(e,f);},b.jribbble.getReboundsOfShot=function(a,h,g){var f=b.jribbble.paths.shots+a+b.jribbble.paths.rebounds;b.fn.jribbble().makeRequest(f,h,g);
},b.jribbble.getShotsByList=function(a,h,g){var f=b.jribbble.paths.shots+a;b.fn.jribbble().makeRequest(f,h,g);},b.jribbble.getShotsByPlayerId=function(a,h,g){var f=b.jribbble.paths.players+a+b.jribbble.paths.shots;
b.fn.jribbble().makeRequest(f,h,g);},b.jribbble.getShotsThatPlayerFollows=function(a,h,g){var f=b.jribbble.paths.players+a+b.jribbble.paths.shots+b.jribbble.paths.following;
b.fn.jribbble().makeRequest(f,h,g);},b.jribbble.getPlayerById=function(a,f){var e=b.jribbble.paths.players+a;b.fn.jribbble().makeRequest(e,f);},b.jribbble.getPlayerFollowers=function(a,h,g){var f=b.jribbble.paths.players+a+b.jribbble.paths.followers;
b.fn.jribbble().makeRequest(f,h,g);},b.jribbble.getPlayerFollowing=function(a,h,g){var f=b.jribbble.paths.players+a+b.jribbble.paths.following;b.fn.jribbble().makeRequest(f,h,g);
},b.jribbble.getPlayerDraftees=function(a,h,g){var f=b.jribbble.paths.players+a+b.jribbble.paths.draftees;b.fn.jribbble().makeRequest(f,h,g);},b.jribbble.getCommentsOfShot=function(a,h,g){var f=b.jribbble.paths.shots+a+b.jribbble.paths.comments;
b.fn.jribbble().makeRequest(f,h,g);},b.jribbble.getShotsThatPlayerLikes=function(a,h,g){var f=b.jribbble.paths.players+a+b.jribbble.paths.shots+b.jribbble.paths.likes;
b.fn.jribbble().makeRequest(f,h,g);};})(jQuery);if(navigator.userAgent.match(/iPhone/i)){detectOrientation();window.onorientationchange=detectOrientation;
function detectOrientation(){var a=(window.innerWidth>0)?window.innerWidth:screen.width;if(a<"768"){$("#locations span").css("top","30%");$(".map").css("height","165px");
}else{if(a=="768"){}}}}console.log("Feel free to look around, but create your own; don't steal. Questions or feedback: http://twitter.com/sican");$(".to_top").click(function(){$("body,html").animate({scrollTop:0},300);
return false;});if(navigator.userAgent.match(/iPhone/i)){window.addEventListener("load",function(){setTimeout(function(){window.scrollTo(0,1);},500);});
}$.jribbble.getShotsByPlayerId("sican",function(b){var a=[];$.each(b.shots,function(d,c){a.push('<li><a href="'+c.url+'" class="img dribbble_shot" target="_blank">');
a.push('<img src="'+c.image_url+'" ');a.push('alt="'+c.title+'"></a></li>');});$("#shots").html(a.join(""));},{page:1,per_page:6});