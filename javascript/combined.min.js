...
$(this).children(".cover_image").fadeOut("500");},function(){$(this).children(".cover_image").css("display","block");});$("body").mouseup(function(b){var a=$(".expand_container>div");
...
expanded=false;return false;}$(".reading_time").text(function(a,b){return Math.round(parseFloat(b));});